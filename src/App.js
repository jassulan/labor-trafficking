    ...
    return (
      <div class="row menu">
        <div class="col-md-2 col-lg-2 lis new-lis">
          <a href="/prepare" class={this.state.page == 2 ? 'active' : ''}>
            Prepare
          </a>
        </div>
        <div class="col-md-2 col-lg-2 lis new-lis">
          <a href="/assess" class={this.state.page == 3 || this.state.page == 5 ? 'active' : ''}>
            Assess
          </a>
        </div>
        {/*<div class="col-md-2 col-lg-2 lis new-lis">
        ...
        <div class="col-md-2 col-lg-2 lis new-lis">
          <a
            href="/resourcesHome"
            class={this.state.page == 6 || this.state.page == 8 || this.state.page == 10 ? 'active' : ''}
          >
            Resources
          </a>
        </div>
        <div class="col-md-2 col-lg-2 lis new-lis">
          <a href="/statute" class={this.state.page == 7 ? 'active' : ''}>
            Massachusetts Law
          </a>
        </div>
        <div class="col-md-2 col-lg-2 lis new-lis">
          <a href="/about" class={this.state.page == 9 ? 'active' : ''}>
            About Us
          </a>
        </div>
      </div>
    ...
    return (
      <div class="mobile-menu hidden-md hidden-lg">
        ...
        <div class="lis new-lis">
          <a href="/resourcesHome" class={this.state.page == 6 || this.state.page == 8 ? 'active' : ''}>
            Resources
          </a>
        </div>
        ...
        <div className="Assess" ref="main" style={this.state.mobileMenu ? { left: '-70vw' } : { left: '0' }}>
          ...
          <Switch>
            <Route
              exact
              path="/"
              render={(props) => <RouteHandler init={this._onHomeClick} render={this.renderHome.bind(this)} />}
            />
            <Route
              exact
              path="/prepare"
              render={(props) => <RouteHandler init={this._onPrepareClick} render={this.renderPrepare.bind(this)} />}
            />
            <Route
              exact
              path="/assess"
            ...
            <Route
              ...
              path="/resources"
              render={(props) => (
                <RouteHandler init={this._onResourcesClick} render={this.renderResources.bind(this)} />
              )}
            />
            <Route exact path="/report" component={Report} />
            <Route exact path="/about" component={About} />
            <Route exact path="/statute" component={Statute} />
            <Route exact path="/resourcesHome" component={Resources} />
          </Switch>
        </div>
